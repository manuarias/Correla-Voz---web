            ...
            {albums.map((album, index) => (
              ...
              >
                <div className="relative aspect-[4/3] overflow-hidden">
                  <img src={album.imageUrl} alt={`Murga Correla Voz, Tandil — ${album.title}${album.date ? ` — ${album.date}` : ''}`} loading="lazy" className="w-full h-full object-cover transition-transform duration-500 ease-in-out group-hover:scale-110 group-hover:-rotate-1" />
